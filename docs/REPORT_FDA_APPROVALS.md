...
![Odds ratios by evidence type](figures/fig12_line_odds_ratios.png)
...
![Composite evidence U-curve](figures/fig13_composite_ucurve.png)
...
![Evidence score distributions](figures/fig11_line_score_distributions.png)
...
![Phase transitions by human genetic support](figures/fig1_phase_transitions_by_tier.png)

**Human genetic support isn't uniform across therapeutic areas:**

![Therapeutic area × human genetic support](figures/fig3_ta_x_tier.png)
...
![Modality × human genetic support](figures/fig2_modality_x_tier.png)
...
![92% failure decomposed](figures/fig7_92pct_decomposed.png)
...
![Family precedent U-curve](figures/fig8_family_precedent.png)
...
![Target essentiality (LOEUF) vs approval](figures/fig10_loeuf.png)
...
![Sponsor drug-approval rate](figures/fig16_sponsor_success_rates.png)
...
- **`METHODOLOGY.md`** — full pipeline documentation, every API + LLM call
- **`REPORT_FULL.md`** — extended analysis with all cross-tabs and sub-sections
- **`CASE_STUDIES.md`** — 6 preclinical-strong / clinical-fail drug case studies
- **`CATALOG.md`** — file inventory across `fda_approvals/`, `clinical_trials/`, `target_evidence/`
- **`figures/`** — all charts referenced above
- **`MODEL_SPEC.md`** — handoff spec for building a predictive model
- **`../PRECLINICAL_EVIDENCE_SPEC.md`** — full evidence taxonomy (8 categories, ~45 dimensions)
- **`../ANSWERS.md`** — direct answers to the 5 core research questions with effect sizes
- **`../drug_evidence_full.csv`** — master per-drug × A-I evidence dataset (1,479 rows)
- **`../COVERAGE_AND_EFFECTS.md`** — evidence × outcome coverage matrix + effect sizes
- **`../EFFECT_SIZES_V2.md`** — line-score effect sizes on 24,706-program cohort
- **`../drug_evidence_full_enriched.csv`** — 1,479-row master + 22 genome-browser DB columns
- **`../drug_evidence_master_v2.csv`** — **comprehensive 30,517-row master (all industry Phase 1-3 drugs 2015-2025)**
- **`../drug_evidence_master_v2_enriched.csv`** — comprehensive master + genome-browser enrichment
- **`../EFFECT_SIZES_COMPREHENSIVE.md`** — effect sizes on the full 30,517 cohort
- **`../EFFECT_SIZES_FINAL.md`** — TIGHT + BROAD cohort effect sizes with presumptive-failure classification
- **`../drug_evidence_master_v2_broad.csv`** — comprehensive master + outcome_broad (10,102 silent kills classified as presumptive failures)
- **`../EFFECT_SIZES_V3.md`** — effect sizes on the 1,479 subset
- **`../enrich_from_genomebrowser.py`** — Neon-DB enrichment script (accepts input/output paths)
