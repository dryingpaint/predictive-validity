...
*(Part of this PR — the capstone of the Section-5 hindsight analysis; see
`MODEL_SYSTEM_PREDICTIVENESS.md`. References to "#9/#13" below mean this PR's own
literature and drug-efficacy tiers; PR #12 is the standalone full literature time-slice.)*

**The question.** We time-gated cell/animal **literature** (this PR's Tier 1 / PR #12) and
**drug-efficacy** (this PR's Tier 2) — require the evidence to predate the trial — and both **collapsed toward the
